...
$sql_query_admin = $mysqli->query("SELECT * FROM usuarios WHERE id = '$id_user'") or die($mysqli->error);
$user_data = $sql_query_admin->fetch_assoc();
...
<head>
    <title>EAD - The Knowlege of Distance</title>
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="header-notification">
                                <a href="#!">
                                    ...
                                    <?php echo number_format($user_data['creditos'], 2, '.', ','); ?>
                                </a>
                            </li>
                            <?php } ?>
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li>
                                        <a href="logout.php">
                                            <i class="ti-layout-sidebar-left"></i> Exit
                                        </a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="index.php">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Home Page</span>
                                ...
                                <li class="">
                                    <a href="index.php?p=store">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Courses
                                            Store</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="index.php?p=mycourses">
                                        <span class="pcoded-micon"><i class="ti-control-play"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">My Courses</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="logout.php">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Exit</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="index.php?p=manage_courses">
                                        <span class="pcoded-micon"><i class="ti-panel"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Manage Courses</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="">
