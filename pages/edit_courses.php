        ...
        if ($works != false) {
            ...
            if ($changeImage)
                $sql_code = "UPDATE cursos SET 
                    titulo = '$title', descricao_curta = '$short_description', conteudo ='$content', preco = '$price', imagem = '$works'
                WHERE id = '$id'";
            else
                $sql_code = "UPDATE cursos SET 
                    titulo = '$title', descricao_curta = '$short_description', conteudo ='$content', preco = '$price'
                WHERE id = '$id'";
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $course['titulo']; ?>" class="form-control"
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $course['descricao_curta']; ?>"
                                        class="form-control" name="descricao_curta" id="descricao_curta">
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $course['preco']; ?>" class="form-control"
                                        name="preco" id="preco">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="conteudo" id="conteudo" cols="30"
                                        rows="10"><?php echo $course['conteudo']; ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
